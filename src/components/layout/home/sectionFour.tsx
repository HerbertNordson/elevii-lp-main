  ...
  return (
    <Container>
      <div className="h-full max-w-6xl m-auto transition-all animate-fade">
        <h2 className="text-center text-3xl md:text-5xl font-bold text-txt mb-16 md:mb-32 pop">
        ...
        <div className="flex flex-wrap gap-2 md:gap-0 md:flex-nowrap justify-center items-start divide-dashed md:divide-x-2 divide-txt-light">
          <div>
            ...
            <div className="px-0 py-4 md:p-6 max-w-lg">
              <h3 className="text-xl text-primary mt-3 md:mt-6 mb-1 md:mb-3 pop">
                Projeto individual
              </h3>
              <p className="text-lg text-txt pop">
